class AppleDeploy < Formula
  ...
  def man_page_content
    <<~EOS
      .TH APPLE-DEPLOY 1 "January 2025" "apple-deploy 2.9.0" "iOS Development Tools"
      .SH NAME
  ...
  test do
    ...
    assert_match "iOS FastLane Auto Deploy v2.9.0", shell_output("#{bin}/apple-deploy version")
