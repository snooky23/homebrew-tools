class IosDeployPlatform < Formula
  ...
  url "https://github.com/snooky23/ios-deploy-platform/archive/refs/tags/v2.5.0.tar.gz"
  license "MIT"
  version "2.5.0"
  sha256 "39b5cabfb7490694b56963fe87df0cdb7ff32bf5a437de80121a3bf752d308b6"
  ...
  def ios_deploy_script
    <<~EOS
      ...
      show_usage() {
          cat <<EOF
      📱 iOS FastLane Auto Deploy v2.5.0
      ...
      main() {
          case "$1" in
              "help"|"--help"|"-h"|"")
                  ...
                  ;;
              "version"|"--version"|"-v")
                  echo "iOS FastLane Auto Deploy v2.5.0"
  ...
  def man_page_content
    <<~EOS
      .TH IOS-DEPLOY 1 "January 2025" "ios-deploy 2.5.0" "iOS Development Tools"
      .SH NAME
  ...
  test do
    ...
    assert_match "iOS FastLane Auto Deploy v2.5.0", shell_output("#{bin}/ios-deploy version")
